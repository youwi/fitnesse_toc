...
/**
 * fitnesse_toc
 * Created by yu on 2018/2/27.
 */
public class NewYearAttendaceTest {
//    var userId = "204654"
//    var attendanceUrl = "/api/biz/activity/newYear/attendance"
////    public void String getAttendanceUrl = "/api/biz/activity/newYear/getAttendance";
//
...
//    /*public void String httpUrlPrefix = "http://www.lieluobo.testing";
//    public void String jdbcUrl = "jdbc:mysql://172.16.52.81:3306/testing?useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false";
//    public void String jdbcUser = "testing";
//    public void String jdbcPassword = "haolie123";*/
//
//
//    //    @Before
//    public void  loginHR() {
...
//    }
//
//    public void  fackDataBy(dayIndex: Int) {
...
//    }
//
//    public void  fackDataMoney(count: Int, money: Int) {
...
//    }
//
//    public void  createDataMoney(count: Int, money: Int, ud: String, type: String) {
//        val rdstring = DataMaker.string(25)
//        val type = type//红包活动
//        val countString = 2000//特殊序号,
//        userId = ud
...
//
//
//    public void  createDataProjectTargetAndInterview(count: Int, ud: String, type: String) {
//        val rdstring = DataMaker.string(25)
//        val type = type//红包活动
//        val countString = 2000//特殊序号,
//        userId = ud
...
//
//    @Test
//    public void  deleteHistoryNewInterviewRedpacket() {
//        val userId = 204812
...
//     * @return
//     */
//    public void  signCount(count: Int): List<*> {
//        val list = ArrayList<String>()
//        for (i in 0 until count) {
//            deleteToday()//删除今天的记录
...
//    }
//
//    public void  report(list: List<String>) {
//        var count188 = 0
//        var count888 = 0
//        var count88 = 0
//        var count1880 = 0
