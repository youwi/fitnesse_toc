...
public class ConfigConstantsDev {

    public final static String LIE_LUO_BO_CW_URL="http://cw.dev.haolie.cn";
    public final static String LIE_LUO_BO_HR_URL="http://hr.dev.haolie.cn";
    public final static String LIE_LUO_BO_WWW_URL="http://am2-dev.imd.com";
