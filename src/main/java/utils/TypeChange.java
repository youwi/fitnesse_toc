...
public class TypeChange {
    ...
    public static byte[] stringToByteArray(String pathString) throws IOException{
...
//    public static byte[] stringToYouKuByteArray(String pathString) throws IOException{
//        File f = new File(pathString);
//        byte[] data = FileUtil.getBytesFromFile(f);
//        return data;
//    }

    public static UploadBytesRequest stringToUploadBytesRequest(String pathString) throws IOException{
        File f = new File(pathString);
