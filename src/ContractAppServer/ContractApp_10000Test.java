...
public class ContractApp_10000Test {
	Data data;
	JSONParse jp;
	
	private String url ="http://192.168.1.15:8123/contractAppserver/contract/op_contract_scan.rest";
    
	
	public ContractApp_10000Test() {
		 data = new Data();
	     jp = new JSONParse();
	}
